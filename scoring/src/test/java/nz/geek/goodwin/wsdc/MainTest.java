...
class MainTest {
    ...
    void exampleFromWsdcForm() {
        ScoringRound<CallbackOption, CallbackResult> scoringRound = new ScoringRound<>(new CallbackStrategy());
        ...
        scoringRound.addHeadJudgeScore("1", BigDecimal.valueOf(1));
        ...
        scoringRound.addHeadJudgeScore("2", BigDecimal.valueOf(2));
        ...
        scoringRound.addHeadJudgeScore("3", BigDecimal.valueOf(3));
        ...
        scoringRound.addHeadJudgeScore("4", BigDecimal.valueOf(4));
        ...
        scoringRound.addHeadJudgeScore("5", BigDecimal.valueOf(5));
        ...
        scoringRound.addHeadJudgeScore("6", BigDecimal.valueOf(6));
        ...
        scoringRound.addHeadJudgeScore("7", BigDecimal.valueOf(7));
        ...
        scoringRound.addHeadJudgeScore("8", BigDecimal.valueOf(8));
        ...
        scoringRound.addHeadJudgeScore("9", BigDecimal.valueOf(9));
    ...
    void headJudgeDecider() {
        ...
        scoringRound.addHeadJudgeScore("1", BigDecimal.valueOf(4));
        scoringRound.addScore("1","1", CallbackOption.YES);
        scoringRound.addScore("2","1", CallbackOption.YES);
        scoringRound.addScore("3","1", CallbackOption.YES);

        scoringRound.addHeadJudgeScore("2", BigDecimal.valueOf(3));
        scoringRound.addScore("1","2", CallbackOption.YES);
        scoringRound.addScore("2","2", CallbackOption.YES);
        scoringRound.addScore("3","2", CallbackOption.YES);

        scoringRound.addHeadJudgeScore("3", BigDecimal.valueOf(2));
        scoringRound.addScore("1","3", CallbackOption.YES);
        scoringRound.addScore("2","3", CallbackOption.YES);
        scoringRound.addScore("3","3", CallbackOption.YES);

        scoringRound.addHeadJudgeScore("4", BigDecimal.valueOf(1));
        scoringRound.addScore("1","4", CallbackOption.YES);
